...
inputs = {
  ...
  ecs_service_autoscaling = {
    min_capacity        = "#{aws_autoscaling_min_capacity_sellers}#"
    max_capacity        = "#{aws_autoscaling_max_capacity_sellers}#"
