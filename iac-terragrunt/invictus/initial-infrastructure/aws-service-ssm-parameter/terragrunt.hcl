...
inputs = {
  ssm_parameters = {
    ...
    BUCKET_CERTS = {
      ...
      value       = dependency.s3_iotcore.outputs.s3_bucket_name
    ...
    SWITCH_TRANSACTION_CAPS = {
      ...
      value       = "#{parameter_switch_transaction_caps}#"
    ...
    SWITCH_COMMISSION_PLAN = {
      ...
      value       = "#{parameter_switch_commission_plan}#"
    ...
    ENABLE_VIRTUAL_SEQUENCE = {
      ...
      value       = "#{parameter_enable_virtual_sequence}#"
    ...
    GLOBAL_URL_ASSETS = {
      type        = "String"
      name        = "/GLOBAL/URL_ASSETS"
      value       = "https://#{aws_cloudfront_alternate_domain_assets}#"
      description = "URL para acceder a los assets"
    }
  }
}
