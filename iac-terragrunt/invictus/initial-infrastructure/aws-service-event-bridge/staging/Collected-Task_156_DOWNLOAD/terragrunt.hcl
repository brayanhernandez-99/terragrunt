...
inputs = {
  scheduler_name      = "441d119e-f4a8-4027-8e53-c7984f3a9ba2-Collected-Task_156_DOWNLOAD"
  aws_account_id      = "${get_aws_account_id()}"
  description         = "Tarea automática 156 DOWNLOAD"
  iam_role_arn        = dependency.iam_role.outputs.iam_role_arn
  kinesis_name        = "Collected"
  schedule_expression = "cron(*/30 11-11/1 * * ? *)"
  payload = {
    model = {
      idConfiguration = 156
      type            = "DOWNLOAD"
