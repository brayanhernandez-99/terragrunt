...
inputs = {
  scheduler_name      = "e6d92248-6403-4996-bef3-51aa9e1532c4-Collected-Task_13_DOWNLOAD"
  aws_account_id      = "${get_aws_account_id()}"
  description         = "Tarea automática 13 DOWNLOAD"
  iam_role_arn        = dependency.iam_role.outputs.iam_role_arn
  kinesis_name        = "Collected"
  schedule_expression = "cron(*/5 0-2/1 * * ? *)"
  payload = {
    model = {
      idConfiguration = 13
      type            = "DOWNLOAD"
