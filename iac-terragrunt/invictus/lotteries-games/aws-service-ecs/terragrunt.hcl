...
inputs = {
  ...
  ecs_task = {
    cpu    = "#{aws_cpu_lotteries_games}#"
    memory = "#{aws_memory_lotteries_games}#"
  ...
  ecs_service_autoscaling = {
    min_capacity        = "#{aws_autoscaling_min_capacity_lotteries_games}#"
    max_capacity        = "#{aws_autoscaling_max_capacity_lotteries_games}#"
  ...
  #   #{aws_scheduled_actions_lotteries_games}#
  # }
}