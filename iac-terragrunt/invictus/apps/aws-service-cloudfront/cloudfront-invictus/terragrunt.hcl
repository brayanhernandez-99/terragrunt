...
dependency "s3" {
  config_path = "../../aws-service-s3/s3-invictus"
  mock_outputs = {
...
dependency "cloudfront-function" {
  config_path = "../../aws-service-cloudfront-function/cloudfront-function-invictus"
  mock_outputs = {
...
inputs = {
  ...
  alternate_domain_names = ["#{aws_cloudfront_alternate_domain_invictus}#"]
  price_class            = "PriceClass_All"
  comment                = "Distribución de CloudFront"
  acm_certificate_arn    = "#{aws_arn_certificate}#"
  aws_cloudfront_tags = {
    Name    = "invictus",
    Project = "microFrontend-invictus"
  }
