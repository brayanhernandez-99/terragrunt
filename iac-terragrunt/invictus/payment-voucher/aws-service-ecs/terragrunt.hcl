...
inputs = {
  ...
  ecs_service_autoscaling = {
    min_capacity        = "#{aws_autoscaling_min_capacity_payment_voucher}#"
    max_capacity        = "#{aws_autoscaling_max_capacity_payment_voucher}#"
  ...
  #   #{aws_scheduled_actions_payment_voucher}#
  # }
}