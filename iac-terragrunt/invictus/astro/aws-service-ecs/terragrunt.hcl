...
dependency "ecs_cluster" {
  ...
  mock_outputs = {
    ...
    ecs_cluster_name = "mock-ecs-cluster-name"
  }
}
...
inputs = {
  ...
  ecs_service_autoscaling = {
    min_capacity        = "#{aws_autoscaling_min_capacity_astro}#"
    max_capacity        = "#{aws_autoscaling_max_capacity_astro}#"
