...
dependency "task_execution" {
  config_path = "../aws-service-iam-profile/ecs-task-execution-role"
  mock_outputs = {
...
dependency "task_role" {
  config_path = "../aws-service-iam-profile/ecs-task-role"
  mock_outputs = {
    iam_role_arn = "arn:aws:iam::123456789012:role/mock-iam-role-arn"
  }
}
...
inputs = {
  ...
  ecs_service_autoscaling = {
    min_capacity        = "#{aws_autoscaling_min_capacity_bff_sellers}#"
    max_capacity        = "#{aws_autoscaling_max_capacity_bff_sellers}#"
    cpu_target_value    = "#{aws_autoscaling_cpu_target_value}#"
    memory_target_value = "#{aws_autoscaling_memory_target_value}#"
  }

  # ecs_service_scheduled_actions = {
  #   #{aws_scheduled_actions_bff_sellers}#
  # }
}