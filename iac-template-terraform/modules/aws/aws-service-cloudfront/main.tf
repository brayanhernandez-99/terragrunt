data "aws_cloudfront_cache_policy" "caching_disabled" {
  count = var.custom_cache_policy_id == null ? 1 : 0
...
resource "aws_cloudfront_distribution" "create_cloudfront" {
  ...
  default_cache_behavior {
    ...
    cache_policy_id        = var.custom_cache_policy_id != null ? var.custom_cache_policy_id : data.aws_cloudfront_cache_policy.caching_disabled[0].id
